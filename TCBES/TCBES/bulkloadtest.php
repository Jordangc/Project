		...
		if(isset($into_database)){
			foreach(array_keys($into_database) as $category){
				foreach(array_keys($into_database[$category]) as $successful_match){
					echo "$successful_match matches " . $into_database[$category][$successful_match] . "<br />";
					echo "DEBUG $into_database[$category][$successful_match] can be found in position: " . $data_position[$into_database[$category][$successful_match]] . "<br />"; 
				}
			}
		}
