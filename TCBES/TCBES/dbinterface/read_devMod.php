...
// includes location_details info
...
round(location_details.north_degree,4) as north_degree, round(location_details.west_degree,4) as west_degree,
specimen.cabinet_code, specimen.box_code, specimen.section_code, specimen.abbr4_organization
from collection, event, location, collector, life, specimen, location_details
where collection.event_code = event.event_code and
location.location_detail_code = location_details.location_detail_code and
